...
#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Hacker_BoyBS
...
\033[1;95m███████║█████╗░░██║░░██╗░
\033[1;95m██╔══██║██╔══╝░░██║░░╚██╗
\033[1;95m██║░░██║██║░░░░░╚██████╔╝  AFGHANISTAN ZINDA BAD
\033[1;95m╚═╝░░╚═╝╚═╝░░░░░░╚═════╝░
...
\033[1;95m▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌▌
   ...
   \033[1;92m███████▒▒Welcome To Hacker BoyBS team▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mA.Creations\033[1;95m♡╭───•◈•───╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mHacker BoyBS
\033[1;94mHacker\033[1;91m: \033[1;91▒▓██████████████]99.9
\033[1;94mFacebook\033[1;91m: \033[1;91mHacker BoyBS
...
jalan('\033[1;93m   ┈┈┈I love you Afghanistan girl☠️ ')
jalan("\033[1;96m   ┈┈┈best hacker in Afghanistan  HackerBoyBS❤ ")
...
def pilih_super():
	...
	print "\033[1;95m♡───────•◈•──────♡\033[1;96mA.creations\033[1;95m♡──────•◈•────♡"
	jalan(' \033[1;93m ........Cloning Start plzzz Wait BoyBS.......... ')
	print "\033[1;95m♡───────•◈•──────♡\033[1;96mA.creations\033[1;95m♡──────•◈•────♡"
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mA.creations\033[1;95m♡───•◈•───────♡"
	print "  \033[1;93m«---•◈•---Developed By Hacker ---•◈•---»" #Dev:Hacker_BoyBS
